## Esercizio: Produttor/Consumatore con vettore di stato e semafori
...
```
dove `id_cliente` è il PID del cliente che ha prenotato il posto (inizialmente 0), e stato indica se il posto è libero (0), occupato (1), o in_aggiornamento (2) da parte di un altro cliente. Una variabile disponibilità indica il numero di posti ancora presenti in teatro (inizialmente 80).
